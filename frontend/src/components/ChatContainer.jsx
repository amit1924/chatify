...
//     // 🌍 Handle generic links (Facebook, Instagram, etc.)
...
//     // IIFE for async calls
//     (async () => {
//       await getMessagesByUserId(selectedUser._id); // Load messages
//       await markAllMessagesFromSelectedAsSeen(); // ✅ Mark old messages as seen immediately
//     })();

//     subscribeToMessages(); // Real-time incoming messages
//     subscribeToTyping(); // Typing indicator
...
//     unsubscribeFromMessages,
//     unsubscribeFromTyping,
//     markAllMessagesFromSelectedAsSeen, // Add this so effect sees changes
//   ]);
...
//     if (msg.senderId !== authUser._id) return null; // only show for my messages

//     if (msg.seenBy?.length > 0) {
//       return <span className="text-xs text-cyan-400 ml-2">✓✓</span>; // seen
//     }
//     if (msg.deliveredTo?.length > 0) {
//       return <span className="text-xs text-gray-400 ml-2">✓</span>; // delivered
//     }
...
//                       {/* Reply preview */}
//                       {replyMsg && (
//                         <div className="mb-1 p-2 border-l-4 border-cyan-400 bg-gray-700 text-xs text-gray-300 rounded">
